...
CAPSTONE_REPO_NAME=charactermodificationprogramlbc
GITHUB_GROUP_NAME=bugbusterslbc
...
export LBC_GROUP_NAME=bugbusterslbc
export LBC_REPO_NAME=ata-lbc-project-beangel1218

# Do not modify the rest of these unless you have been instructed to do so.
export LBC_PROJECT_NAME=ata-lbc-project-beangel1218
